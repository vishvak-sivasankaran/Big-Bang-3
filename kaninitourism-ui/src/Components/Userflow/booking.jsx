...
const Booking = () => {
    ...
    return (
        <div>
            ...
            <br></br>
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                <div style={{ backgroundColor: '#', width: 1000, flexWrap: "wrap", display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <div style={{ backgroundColor: '#', width: 1000, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <h5>Day Planner</h5>
                    </div>
                    <br></br>
                    {spotsData.length > 0 && (
